              ...
              <tr key={i.id} className="hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer" onClick={()=>setShowModal(i)}>
                ...
                <td className="p-3">
                  <span className={
                    ...
                    (i.status === 'received' ? 'bg-blue-100 text-blue-800' :
                     i.status === 'delivered' ? 'bg-emerald-100 text-emerald-800' :
                     ...
                     i.status === 'failed' ? 'bg-red-200 text-red-900' :
                     i.status === 'warning' ? 'bg-yellow-100 text-yellow-800' :
                     i.status === 'panic' ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800'))
                  }>
                    {i.status || '—'}
                  </span>
                </td>
